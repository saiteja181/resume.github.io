var e, t, n, r, i, a = function() {
    ...
    S = function(e) {
        "hidden" === document.visibilityState && y > -1 && (y = "visibilitychange" === e.type ? e.timeStamp : 0, C())
    },
    b = function() {
    ...
    M = function(e, t) {
        t = t || {}, w((function() {
            ...
            o && (n = p(e, a, r, t.reportAllChanges), d((function(i) {
                a = m("FCP"), n = p(e, a, r, t.reportAllChanges), h((function() {
                    ...
                    u = function(e) {
                        e.forEach((function(e) {
                            if (!e.hadRecentInput) {
                                var t = o[0],
                                    n = o[o.length - 1];
                                a && e.startTime - n.startTime < 1e3 && e.startTime - t.startTime < 5e3 ? (a += e.value, o.push(e)) : (a = e.value, o = [e])
                            }
                        })), a > i.value && (i.value = a, i.entries = o, n())
                    },
                    c = v("layout-shift", u);
                c && (n = p(e, i, r, t.reportAllChanges), g((function() {
                    u(c.takeRecords()), n(!0)
                })), d((function() {
                    a = 0, i = m("CLS", 0), n = p(e, i, r, t.reportAllChanges), h((function() {
                        return n()
                    }))
                })), setTimeout(n, 0))
            })))
    ...
    R = function(n, i) {
        i = i || {}, w((function() {
            var a, o = [100, 300],
                ...
                l = v("first-input", f);
            a = p(n, c, o, i.reportAllChanges), l && g(T((function() {
                f(l.takeRecords()), l.disconnect()
            }))), l && d((function() {
                var u;
                c = m("FID"), a = p(n, c, o, i.reportAllChanges), r = [], t = -1, e = null, k(addEventListener), u = s, r.push(u), D()
            }))
        }))
    },
    N = function(e, t) {
    ...
    j = function(e) {
        e.forEach((function(e) {
            e.interactionId && (H = Math.min(H, e.interactionId), O = Math.max(O, e.interactionId), q = O ? (O - H) / 7 + 1 : 0)
        }))
    },
    U = function() {
    ...
    V = function() {
        "interactionCount" in performance || i || (i = v("event", j, {
            type: "event",
            buffered: !0,
            durationThreshold: 0
        }))
    ...
    Q = function(e, t) {
        t = t || {}, w((function() {
            ...
            var r, i = m("INP"),
                a = function(e) {
                    e.forEach((function(e) {
                        (e.interactionId && K(e), "first-input" === e.entryType) && (!G.some((function(t) {
                            return t.entries.some((function(t) {
                                return e.duration === t.duration && e.startTime === t.startTime
                            }))
                        })) && K(e))
                    }));
                    var t, n = (t = Math.min(G.length - 1, Math.floor(z() / 50)), G[t]);
                    n && n.latency !== i.value && (i.value = n.latency, i.entries = n.entries, r())
                },
                o = v("event", a, {
                    durationThreshold: t.durationThreshold || 40
                });
            r = p(e, i, n, t.reportAllChanges), o && (o.observe({
                type: "first-input",
                buffered: !0
            }), g((function() {
                a(o.takeRecords()), i.value < 0 && z() > 0 && (i.value = 0, i.entries = []), r(!0)
            })), d((function() {
                G = [], _ = U(), i = m("INP"), r = p(e, i, n, t.reportAllChanges)
            })))
        }))
    },
    W = function(e, t) {
        ...
        ! function(e, t) {
            t = t || {}, w((function() {
                ...
                if (u) {
                    ...
                    var c = T((function() {
                        X[a.id] || (o(u.takeRecords()), u.disconnect(), X[a.id] = !0, n(!0))
                    }));
                    ["keydown", "click"].forEach((function(e) {
                        addEventListener(e, c, !0)
                    })), g(c), d((function(i) {
                        a = m("LCP"), n = p(e, a, r, t.reportAllChanges), h((function() {
                            a.value = performance.now() - i.timeStamp, X[a.id] = !0, n(!0)
                        }))
                    }))
                }
            }))
...
export {
    x as onCLS, A as onFCP, N as onFID, W as onINP, Y as onLCP, ee as onTTFB
};